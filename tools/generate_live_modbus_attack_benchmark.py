...
def main() -> int:
    ...
    parser.add_argument("--profile", default="tank_pump", choices=("tank_pump",))
    ...
    parser.add_argument(
        ...
        type=int,
        default=6,
        help="Exclusive upper bound for generated reconnaissance addresses.",
    )
    parser.add_argument(
        "--setpoint",
        type=int,
    ...
    options = ModbusAttackGenerationOptions(
        ...
        setpoint_values=tuple(args.setpoints or (550, 720, 650)),
        coil_values=tuple(
            value == "on" for value in (args.coils or ("on", "off", "on"))
        ),
